          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <router-link to="/store" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="ສະຕັອກສິນຄ້າ">
                  ສະຕັອກສິນຄ້າ
                </div>
              </router-link>
            </li>
            <li class="menu-item">
              <router-link to="/pos" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="ຂາຍສິນຄ້າ">
                  ຂາຍສິນຄ້າ pos
                </div>
              </router-link>
            </li>
            <li class="menu-item">
              <router-link to="/transection" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="ການເຄື່ອນໄຫວ">
                  ການເຄື່ອນໄຫວ
                </div>
              </router-link>
            </li>
            <li class="menu-item">
              <router-link to="/report" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="ລາຍ​ງານ">ລາຍ​ງານ</div>
              </router-link>
            </li>
          </ul>
        </aside>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      ...
                      >
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block">Zom Ma</span>
                    ...
                    <li>
                      <a class="dropdown-item" href="pages-profile-user.html">
                        ...
                        <span class="align-middle">ໂປ​ຣ໌​ຟາຍ</span>
                      </a>
                    </li>
                    <li>
                      <a
                      ...
                      >
                        ...
                        <span class="align-middle">ການ​ຕັ້ງ​ຄ່າ</span>
                      </a>
                    </li>
                    <li>
                      <a
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="align-middle"> ອອກ​ຈາກ​ລະ​ບົບ</span>
                      </a>
                    </li>
                  </ul>
                </li>
...
export default {
  ...
  watch: {},
  created() {
    console.log(window.Laravel.isLogin);
